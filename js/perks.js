const Perks = {
    ...
    allRewards: [
        ...
        { level: 10, reward: 'Primary Car Colors', icon: '🎨', type: 'feature' },
        ...
        { level: 16, reward: 'Music Pack: Road Trip Classics', icon: '🎵', type: 'music' },
        { level: 20, reward: 'More Primary Colors', icon: '🎨', type: 'feature' },
        { level: 25, reward: 'Hatchback Car', icon: '🚘', type: 'car' },
        { level: 26, reward: 'Music Pack: Family Favorites', icon: '🎵', type: 'music' },
        { level: 30, reward: 'Secondary Car Colors', icon: '🎨', type: 'feature' },
        { level: 35, reward: 'More Secondary Colors', icon: '🎨', type: 'feature' },
        { level: 36, reward: 'SUV Car', icon: '🛻', type: 'car' },
        { level: 46, reward: 'Music Pack: Michigan Beats', icon: '🎵', type: 'music' },
